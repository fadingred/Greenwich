Proofer is a small app for checking the relative correctness of translations you receive. Translations may be done by volunteers and there is no guarantee of their correctness. Publishing an internationalized version of your application where you have no idea what the text is saying is scary and potentially dangerous.
...
3. Go to https://datamarket.azure.com/developer/applications/ and register an application so you can begin using the translation service. 
